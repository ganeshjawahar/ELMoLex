...
# train the parser
python train.py --word_path sample_run/cc.en.300.vec.sample --train_path sample_run/en_lines-ud-train.conllu --dev_path sample_run/en_lines-ud-dev.conllu --test_path sample_run/en_lines-ud-test.conllu --dest_path sample_run/parser --prelstm_args sample_run/elmo/args.json --lexicon sample_run/UDLex_English-Apertium.conllul --num_epochs 1 --elmo  
# predict the parse tree and compute CONLL'18 scores
python test.py --pred_folder sample_run/parser --system_tb sample_run/en_lines-ud-test_pred.conllu --gold_tb sample_run/gold --tb_out sample_run/en_lines-test-pred.conllu --lexicon sample_run/UDLex_English-Apertium.conllul --word_path sample_run/cc.en.300.vec.sample --lex_expand --vocab_expand
fi
...
# train the parser
python train.py --word_path sample_run/cc.en.300.vec.sample --train_path sample_run/en_lines-ud-train.conllu --dev_path sample_run/en_lines-ud-dev.conllu --test_path sample_run/en_lines-ud-test.conllu --dest_path sample_run/parser --prelstm_args sample_run/elmo/args.json --lexicon sample_run/UDLex_English-Apertium.conllul --elmo
# predict the parse tree and compute CONLL'18 scores
python test.py --pred_folder sample_run/parser --system_tb sample_run/en_lines-ud-test_pred.conllu --gold_tb sample_run/gold --tb_out sample_run/en_lines-test-pred.conllu --lexicon sample_run/UDLex_English-Apertium.conllul --word_path sample_run/cc.en.300.vec.sample --lex_expand --vocab_expand
fi
